...
%\bibitem{G}
%Grissom, A. (2022). courses/17-logistic\_regression.md at master acgrissom/courses. GitHub.

%https://github.com/acgrissom/courses/blob/master/2022-datascience/slides/17-logistic\_regression.md

%\bibitem{ML} Introduction to Machine Learning. (n.d.).

%https://openlearninglibrary.mit.edu/courses/course-v1:MITx+6.036+1T2019/course/

%\bibitem{V}
%J. Verma, ``MNIST Dataset in Python - Basic Importing and Plotting," DigitalOcean Community, 2022, https://www.digitalocean.com/community/tutorials/mnist-dataset-in-python.
